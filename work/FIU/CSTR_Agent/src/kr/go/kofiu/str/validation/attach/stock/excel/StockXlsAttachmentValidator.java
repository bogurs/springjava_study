...
/**
 * STR 첨부파일 증권엑셀 정형화 검증 수행
 * @throws AttachmentValidationException
 */
public class StockXlsAttachmentValidator extends AbstractValidator {
	...
	public StockXlsAttachmentValidator(String orgCd, InputStream inStream)
	...
	public StockXlsAttachmentValidator(String orgCd, Workbook wb)
	...
	public final void refresh(String orgCd) throws XPathExpressionException, IOException,
		...
		this
				.refresh(STRConfigure.getInstance().getAgentInfo().getReportOrgInfo(orgCd).getValidationInfo()
						...
						"/attachment-stock-xls-validation/item");
	};
